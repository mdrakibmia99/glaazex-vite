                ...
                <ul className="w-full">
                  <li>
                    <div className="flex items-center gap-2 px-5 w-full">
                        ...
                        <img className="w-full rounded-lg" src="https://backend.pndservicebd.com//storage/upload/products/thumbnail/1768153516227703.jpeg" alt="" />
                        </div>

                        <div className="w-4/6">
                          <p className="whitespace-nowrap truncate">New Beauty glazed lipsitcs asdf </p>
                          <p>12 <span>Items x </span>10 </p>
                      </div>
