      ...
      <div className="container mx-auto navbar box-border">
        ...
        <div className=" max-w-[300px] lg:w-full md:w-full basis-1/3">
          <div className="join w-full outline-none border-none ">
            <input className="input input-bordered bg-[#eeeeee] border-none   md:w-[250px] lg:w-[250px] join-item rounded-l-full focus:outline-0" placeholder="Search..." />
        ...
        <Link to={'/'} className='hidden lg;flex md:flex justify-center lg:basis-1/3 md:basis-1/3 basis-2/4  '>
