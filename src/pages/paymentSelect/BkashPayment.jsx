...
function BkashPayment({ paymentMethod }) {
    ...
    <section className='w-full '>
      ...
      <div className="form-control w-full">
        ...
        <div className='h-full mt-[50px] mb-2 mx-2 lg:mx-0'>
          <div className='text-sm p-3'><p>Follow below steps 👇</p> <h3 className="font-bold my-3">Step 1: </h3> <ol className="divide-y divide-gray-300"><li className="divide-y divide-gray-300"> প্রথমে উপরে দেওয়া নাম্বার কপি করুণ।</li> <li className="divide-y divide-gray-300"> (bKash,Nagad,Rocket) App অথাবা Ussd কোডের মধ্যেমে সেন্ড মানি অপশন সিলেক্ট করুণ।</li> <li className="divide-y divide-gray-300"> TINAMS PAYMENT নাম্বার (_) প্রবেশ করুণ।</li> <li className="divide-y divide-gray-300"> এম্যাউন্ট অর্থাৎ কত টাকা যোগ করবেন তার পরিমাণ প্রবেশ করুণ।</li> <li className="divide-y divide-gray-300"> 
          {
         `Enter Reference Number "user id". ( রেফারেন্সে আপনার ইউজার আইডি দিন )`}
          </li> <li className="divide-y divide-gray-300"> আপনার বিকাশ পিন নাম্বার প্রবেশ করুণ।.</li></ol> <h3 className="font-bold my-3">Almost Done. Now follow Step 2:</h3> <ol className="divide-y divide-gray-300"><p className="py-2">তারপর নিচে যে দুটি বক্স দেখতে পারছেন</p> <p>প্রথম Box এ কত টাকা পাঠিয়েছেন সেটা লিখে দেবেন।</p> <p className="py-2">দ্বিতীয় বক্সে আপনি যে নাম্বার থেকে টাকা পাঠিয়েছেন সেই নাম্বার লিখে দেবেন।</p> <p>তারপর Add অপশনে ক্লিক করে দাও দুই থেকে পাঁচ মিনিটের মধ্যে টাকা যোগ হয়ে যাবে অবশ্যই টাকা Send Money-করার পড় এই কাজটি করবেন</p></ol></div>
        </div>
